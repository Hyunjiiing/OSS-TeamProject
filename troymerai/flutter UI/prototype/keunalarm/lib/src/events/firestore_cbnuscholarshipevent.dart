...
class firestoreCBNUScholarshipEvent extends StatefulWidget {
  firestoreCBNUScholarshipEvent({super.key});

  @override
  State<firestoreCBNUScholarshipEvent> createState() =>
      _firestoreCBNUScholarshipEvent();
}

class _firestoreCBNUScholarshipEvent
    extends State<firestoreCBNUScholarshipEvent> {
  /**파이어베이스 데이터베이스에 저장된 컬렉션 이름을 불러올 수 있게 함 */
  CollectionReference event =
      FirebaseFirestore.instance.collection('CBNU_scholarship');
