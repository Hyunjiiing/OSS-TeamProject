...
class firestoreComputerEngineeringEvent extends StatefulWidget {
  firestoreComputerEngineeringEvent({super.key});

  @override
  State<firestoreComputerEngineeringEvent> createState() =>
      _firestoreComputerEngineeringEvent();
}

class _firestoreComputerEngineeringEvent
    extends State<firestoreComputerEngineeringEvent> {
  /**파이어베이스 데이터베이스에 저장된 컬렉션 이름을 불러올 수 있게 함 */
  CollectionReference event =
      FirebaseFirestore.instance.collection('ComputerEngineering_notice');
